Este programa permite añadir envios por Servicio FedEX y Servicio postal a un arreglo sin importar cual de los tipos sea, para asi realizar la suma total del costo de todos los envios.
